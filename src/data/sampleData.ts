...
export const sampleEmployees: Employee[] = [
  { id: crypto.randomUUID(), name: 'Alice', roles: ['Supervisor', 'Cashier'], unavailableSlots: [{ days: ['Sunday'] }] },
  { id: crypto.randomUUID(), name: 'Frank', roles: ['Supervisor', 'Cashier'], unavailableSlots: [] },
  { id: crypto.randomUUID(), name: 'Bob',   roles: ['Cook'],                         unavailableSlots: [] },
  { id: crypto.randomUUID(), name: 'David', roles: ['Cook'],                         unavailableSlots: [] },
...
export const sampleShifts: Shift[] = [
  ...
  // Alice (Supervisor,Cashier): Mon-Fri + Sunday → UNAVAILABLE
  // Fix: Frank (Supervisor,Cashier — same roles) free on Sunday
  ...
  // Bob (Cook): Mon-Sat 6 consecutive → MOVE Tue to David (Cook)
  ...
  // Carol (Cashier): Wed overlap 13-21 vs 15-23 → MOVE 15-23 to Eve (Cashier, Wed 7-11)
  ...
  // Carol (Cashier): Fri-Sun this + Mon-Wed next = 6 calendar days
  // Fix: MOVE Wed next to Eve (Cashier, free Wed next)
